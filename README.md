# MODEL1310110049: MODEL1310110049
...
`pip install git+https://github.com/biomodels/MODEL1310110049.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110049.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110049 as model`
...
The model of placenta decidual cells metabolism is derived from the community-
...
and identified by:
[MODEL1310110049](http://identifiers.org/biomodels.db/MODEL1310110049) .
